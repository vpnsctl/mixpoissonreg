...
fit1env <- mixpoissonreg(daysabs ~ math, data = Attendance, envelope = 5,
                         em_controls = list(maxit = 50))
fit2env <- mixpoissonreg(daysabs ~ math, data = Attendance, envelope = 5,
                         em_controls = list(maxit = 50))
...
fit1pigenv <- mixpoissonreg(daysabs ~ math, data = Attendance, model = "PIG", envelope = 5,
                            em_controls = list(maxit = 50))
fit2pigenv <- mixpoissonreg(daysabs ~ math | math, data = Attendance, model = "PIG", envelope = 5,
                            em_controls = list(maxit = 50))
...
fit_ml2env <- mixpoissonregML(daysabs ~ math | math, data = Attendance, envelope = 5)
...
fit_ml1pigenv <- expect_warning(mixpoissonregML(daysabs ~ math, data = Attendance, model = "PIG", envelope = 5))
fit_ml2pigenv <- expect_warning(mixpoissonregML(daysabs ~ math | math, data = Attendance, model = "PIG", envelope = 5))
