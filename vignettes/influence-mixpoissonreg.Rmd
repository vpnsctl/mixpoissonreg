...
schemes were introduced. Cook suggested the analysis of the perturbation schemes in the directions of largest curvatures. [Lesaffre and Verbeke (1998)](https://doi.org/10.2307/3109764) suggested the analysis for each canonical direction and called this "total local influence". [Poon and Poon (1999)](https://doi.org/10.1111/1467-9868.00162) introduced the *conformal
...
The default direction of `local_influence` method for `mixpoissonreg` objects is the canonical direction, that is, it computes the *total local influence* ([Lesaffre and Verbeke, 1998](https://doi.org/10.2307/3109764)). 
